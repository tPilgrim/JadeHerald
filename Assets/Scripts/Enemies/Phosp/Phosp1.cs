...
public class Phosp1 : MonoBehaviour
{
    ...
    public Transform SpellPoint1;
    public Transform SpellPoint2;
    public Transform SpellPoint3;
    ...
    private IEnumerator Spell()
    {
        ...
        if(IsDead == false)
        {
            Instantiate(Bubble1, SpellPoint1.position, SpellPoint1.rotation);
            Instantiate(Bubble2, SpellPoint2.position, SpellPoint2.rotation);
            Instantiate(Bubble3, SpellPoint3.position, SpellPoint3.rotation);
        }
