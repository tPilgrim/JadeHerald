...
public class Attack1 : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerComponent = GameObject.FindGameObjectWithTag("Enemy");
        //Sheild = GameObject.Find("Sheild");
        //PlayerPosition = GameObject.Find("Enemy").transform;
    }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            PlayerComponent.GetComponent<EnemyHealth>().TakeDamage(PhysicalDamage);
